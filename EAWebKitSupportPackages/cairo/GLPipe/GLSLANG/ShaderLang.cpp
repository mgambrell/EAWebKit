...
public:
  ...
  ShShaderOutput getOutputType()
  {
    ...
    return SH_GLSL_CORE_OUTPUT;
  }
};


MyCompiler *GetCompilerFromHandle(ShHandle handle)
{
    if (!handle)
        return NULL;
...
const std::vector<sh::Uniform> *ShGetUniforms(const ShHandle handle)
{
  ...
  static std::vector<sh::Uniform> ret;
  return &ret;
}
...
const std::vector<sh::Varying> *ShGetVaryings(const ShHandle handle)
{
  ...
  static std::vector<sh::Varying> ret;
    return &ret;
}
...
const std::vector<sh::Attribute> *ShGetAttributes(const ShHandle handle)
{
    ...
    static std::vector<sh::Attribute> ret;
    return &ret;
}
...
const std::vector<sh::InterfaceBlock> *ShGetInterfaceBlocks(const ShHandle handle)
{
 //   return GetShaderVariables<sh::InterfaceBlock>(handle, SHADERVAR_INTERFACEBLOCK);
  static std::vector<sh::InterfaceBlock> ret;
  return &ret;
}
