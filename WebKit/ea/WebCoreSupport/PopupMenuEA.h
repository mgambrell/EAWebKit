...
public:
    ...
    void OverlayBegin(void) override;  //MBG - FIXED
	void OverlayEnd(void) override;  //MBG - FIXED
    void OnKeyboardEvent(const EA::WebKit::KeyboardEvent& keyboardEvent) override;  //MBG - FIXED
	void OnMouseMoveEvent(const EA::WebKit::MouseMoveEvent& mouseMoveEvent) override;  //MBG - FIXED
	void OnMouseButtonEvent(const EA::WebKit::MouseButtonEvent& mouseButtonEvent) override;  //MBG - FIXED
	void OnMouseWheelEvent(const EA::WebKit::MouseWheelEvent& mouseWheelEvent) override;  //MBG - FIXED
	bool OnButtonEvent(const EA::WebKit::ButtonEvent& buttonEvent) override;  //MBG - FIXED
	void OnFocusChangeEvent(bool hasFocus) override;  //MBG - FIXED
...
private:
	...
	virtual IntSize visibleSize() const override;  //MBG - FIXED
